    ...
    return (
        <footer className="footer-container">
          <div className="social-links">
            ...
            <a href="https://workspace.google.com/intl/en-US/gmail/" aria-label="gmail" target="_blank" >
              <img src={gmail} alt="gmail logo" className="footer-img" />
            </a>
            <a href="https://github.com/orgs/Web1-Teams/teams/8am-grp7-team" aria-label="githup" target="_blank" >
